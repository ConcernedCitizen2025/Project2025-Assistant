...
<p><strong>Note:</strong> This map was last updated on <strong>{{ site.time | date: '%B %-d, %Y' }}</strong>. If you are looking for protests outside of California, please visit the full interactive map or the Mobilize event directory below:</p>
<ul>
